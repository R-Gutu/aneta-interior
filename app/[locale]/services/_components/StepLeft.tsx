...
export default function StepLeft({ titleKey, contentKey, imagePath, number } : {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 mt-6 sm:mt-10 gap-6 lg:gap-0 px-5 lg:px-10">
            {/* Image Section */}
            <div className="w-full h-64 sm:h-80 md:h-96 lg:h-full flex justify-center lg:justify-end lg:pl-5 lg:pb-5 lg:border-l-3 lg:border-b-3 border-[#EAE9E5] order-2">
            ...
            {/* Content Section */}
            <div className="grid grid-rows-1 lg:grid-rows-2 gap-4 lg:gap-5 order-1">
                {/* Title Section */}
