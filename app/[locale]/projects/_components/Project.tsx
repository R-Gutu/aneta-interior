    ...
    return (
      <div className="relative w-full h-full">
        ...
        <Image
          ...
          quality={75}
          // placeholder="blur"
          // blurDataURL="data:image/jpeg;base64,"
