...
export default function Footer() {
    const socials = [
        {
            link: "",
            image: "/svgs/socials/instagram.svg",
            name: "instagram"
        },
        {
            link: "",
            image: "/svgs/socials/tiktok.svg",
            name: "tiktok"
        },
        {
            link: "",
            image: "/svgs/socials/facebook.svg",
            name: "facebook"
        },
        {
            link: "",
            image: "/svgs/socials/whatsapp.svg",
            name: "whatsapp"
        },
        {
            link: "",
            image: "/svgs/socials/telegram.svg",
            name: "telegram"
        }
    ]
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 lg:gap-20 py-12 lg:py-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <h4 className="font-inter font-bold text-black text-lg">ADRESA:</h4>
                                    <address className="font-montserrat text-gray-600 text-sm not-italic leading-relaxed">
                                        România, mun. București,<br />
                                        str. Splaiul Independenței, 202 B
                                    </address>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col justify-between space-y-8 lg:space-y-0 lg:min-h-[300px]">
                        ...
                        <nav className="space-y-4 lg:space-y-6">
                            <h3 className="font-inter font-bold text-black text-lg lg:hidden">Navigare</h3>
                ...
                <div className="border-t border-gray-200/50 py-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
                        <p className="font-montserrat text-gray-500 text-xs leading-relaxed">
                            © 2025 Aneta Design Interior. Toate drepturile rezervate.
                        </p>
