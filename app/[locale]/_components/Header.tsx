        ...
        <div className={cn(
          ...
          <ul className={cn(
            ...
            {NAV_ITEMS.map(({ key, link }) => (
              <m.li
                key={key}
                className="cursor-pointer font-inter text-black transition-colors duration-200 hover:text-amber-600 px-2 py-1 rounded-md hover:bg-gray-50"
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <div className={cn(
                              "rounded-full bg-gray-100 flex items-center justify-center group-hover:bg-amber-600 transition-colors duration-200",
